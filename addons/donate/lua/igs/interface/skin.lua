...
IGS.S.COLORS = {
    FRAME_HEADER        = Color(40,40,40,240), -- Фон верхушки фреймов в т.ч. пополнения счета и т.д. https://img.qweqwe.ovh/1491950958825.png
    ACTIVITY_BG         = Color(50,50,50,240), -- Фон в каждой вкладке (основной) https://img.qweqwe.ovh/1509370647204.png
    TAB_BAR             = Color(45,45,45,240), -- Фон таб бара https://img.qweqwe.ovh/1509370669492.png
 
    PASSIVE_SELECTIONS  = Color(40,40,40), -- Фон панели тегов, цвет кнопки с балансом, верхушки таблиц, не выделенные кнопки https://img.qweqwe.ovh/1509370720597.png
    INNER_SELECTIONS    = Color(35,35,35), -- Фон иконок на плашках, фон панелек последних покупок... https://img.qweqwe.ovh/1509370766148.png
 
    SOFT_LINE           = Color(55,55,55), -- Линия между секциями, типа "Информация" и "Описание" в инфе об итеме
    HARD_LINE           = Color(55,55,55), -- Обводки панелей
 
    HIGHLIGHTING        = Color(130,130,130),   -- Обводка кнопок, цвет текста не активной кнопки
    HIGHLIGHT_INACTIVE  = Color(85,85,85), -- Цвет иконки неактивной кнопки таббара, мигающая иконка на фрейме помощи https://img.qweqwe.ovh/1509371884592.png
