...
ENT.upgrades = {
	CPU = {name = "Скорость CPU +256MHz", cost = {2000,400,8000,16000,320000, 64000, 128000}, amountPerUpgrade = 0.256},
	CORES = {name = "Добавляет дополнительное ядро", cost = {50000, 10000, 175000}}
}
