...
ENT.upgrades = {
	CPU = {name = "Скорость CPU +256MHz", cost = {2000,400,8000,16000,32000, 64000, 128000}, amountPerUpgrade = 0.256},
	CORES = {name = "Добавляет дополнительное ядро", cost = {}} //Altough were not using it, by having an empty table it will prevent errors
}
