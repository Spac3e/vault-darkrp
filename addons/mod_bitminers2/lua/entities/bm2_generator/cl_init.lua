	...
	if LocalPlayer():GetPos():Distance(self:GetPos()) < 350 then
		...
		cam.Start3D2D(pos, self.cam2d3dAng, 0.05)
			if not self:GetShowToMuchPowerWarning() then
				...
				draw.SimpleText("Вы используете много энергии!", "BM2GeneratorFont", 0, 170, Color(0,0,0, 255), 1, 1)
				draw.SimpleText("Вы используете много энергии!", "BM2GeneratorFont", -1, 170 - 1, Color(255,255,255, 255), 1, 1)

				draw.SimpleText("Пожалуйста отключите некоторые сервера или найдите другие источники питания.", "BM2GeneratorFont", 0, 170 + 35, Color(0,0,0, 255), 1, 1)
				draw.SimpleText("Пожалуйста отключите некоторые сервера или найдите другие источники питания.", "BM2GeneratorFont", -1, 170 - 1 + 35, Color(255,255,255, 255), 1, 1)
