...
-- COCAINE BUYER NPC
TCF.Config.NPCDisplayName = "Скупщик кокаина" -- The display name shown above the NPC
TCF.Config.NPCDisplayDescription = "Ниггер которому нужен твой кокс." -- The description displayed above the NPC.
