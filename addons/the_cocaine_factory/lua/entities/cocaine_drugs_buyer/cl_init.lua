...
net.Receive( "TCF_SellDrugsMenu", function( length, ply )
	...
	DialogBox.Paint = function()
		draw.RoundedBoxEx( 8, 1, 1, DialogBox:GetWide(), DialogBox:GetTall(), Color( 15, 15, 15, 240 ), false, false, false, false )
	end
	...
	DialogHeadText:SetText( table.Random( { "Здарова", "Доров, братишка", "Как оно?", "Хай", "Что нового?" } ) )
	...
	RewardText:SetText( "+".. rp.FormatMoney( CocainePayout ) )
	...
	ConfirmButton:SetToolTip( TCF.Config.Lang["Accepting the druggies offer will give you"][TCF.Config.Language] .." ".. rp.FormatMoney( CocainePayout ) )
