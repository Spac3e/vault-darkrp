if SERVER then
	resource.AddWorkshop("929883435")
end
...
SWEP.ViewModel = "models/props_workshop/fidget_spinner.mdl"
SWEP.WorldModel = "models/props_workshop/fidget_spinner.mdl"
SWEP.Weight = 5
...
if CLIENT then
    ...
    function SWEP:DrawHUD()
        ...
        if d > 0 then
            draw.WordBox(8, ScrW() * 0.3, ScrH() - 50, tostring(d) .. " RPM", "ui.24", Color(0, 0, 0, 100), Color(255, 255, 255, 255))
        end
    end
...
if CLIENT then
    ...
    function CustomFidgetOpenPanel()
        ...
        local DButton = vgui.Create("ui_button", Frame)
        DButton:SetPos(128, 200)
        DButton:SetText("Выбрать!")
