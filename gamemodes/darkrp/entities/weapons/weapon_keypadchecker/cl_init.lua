...
function SWEP:DrawHUD()
	draw.WordBox(2, 10, ScrH() / 2, "Shoot a keypad to see what it controls.", "ChatFont", Color(0,0,0,120), Color(255, 255, 255, 255))
	draw.WordBox(2, 10, ScrH() / 2 + 20, "Shoot a Fading door/thruster/whatever to see which keypads are connected to it.", "ChatFont", Color(0,0,0,120), Color(255, 255, 255, 255))
	draw.WordBox(2, 10, ScrH() / 2 + 40, "Right click to clear.", "ChatFont", Color(0,0,0,120), Color(255, 255, 255, 255))
