...
local function MsgDoVote(msg)
	...
	for i = 20, utf8.len(question), 22 do
	...
	if LocalPlayer():IsAdmin() then
		...
		nbutton.Paint = function(self, w, h)
			draw.RoundedBox(5, 0, 0, w, h, (self.Hovered and ui.col.CloseHovered or ui.col.CloseBackground))
		end
